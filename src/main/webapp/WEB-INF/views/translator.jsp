  ...
  <head>
    ...
    <style>
        ...
        *{margin:0px auto; text-align: center; text-decoration: none; color:#000;}
        ...
        #results {font-size: 14px; font-weight: bold; border: 1px solid #ddd; padding: 15px; text-align: left; height: 200px; overflow-y: auto; max-width:800px; margin:50px auto; box-shadow:0 5px 10px -5px #333;}
  ...
  <body class="" id="grid">
    <div class="browser-landing" id="main">
      <div class="compact marquee">
        ...
        <textarea></textarea>
        <div id="append">
          <span id="btn"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/VisualEditor_-_Icon_-_Arched-arrow-ltr.svg/1024px-VisualEditor_-_Icon_-_Arched-arrow-ltr.svg.png" width="35" height="35" alt="(copy)""></span>
        </div>
      </div>
    </div><script src="/intl/en/chrome/assets/common/js/chrome.min.js"></script> 
    <script>
